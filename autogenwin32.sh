...
aclocal -I /local/share/aclocal/ -I m4 $aclocalinclude || {
    echo
...
conf_flags="--build=i686-pc-mingw32  --host=i686-pc-mingw32 --enable-maintainer-mode --prefix=/local --disable-debug --without-x --enable-distribution --enable-exercises"
