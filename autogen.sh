...
conf_flags="--enable-maintainer-mode --enable-compile-warnings --enable-debug --enable-gnome --enable-distribution --enable-exercises --enable-dbus --enable-tests --enable-tracing --enable-experimental --enable-indicator --enable-gnome3"
