...
Source: "..\..\..\shared\exercises\exercises.xml"; DestDir: "{app}\share\exercises\"; Flags: ignoreversion
...
Source: "..\..\workrave.exe"; DestDir: "{app}\lib"; DestName: "Workrave.exe"; Flags: ignoreversion;
