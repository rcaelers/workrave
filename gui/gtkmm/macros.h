 ...
 * All rights reserved.
 *
 * Time-stamp: <2002-11-12 20:42:58 robc>
 *
...
#define WR_METHOD_IMPL(rettype, method, args...) \
	rettype WR_C_CLASS::static_##method (PortableServer_Servant s, args, CORBA_Environment *ev)    \
        {                                                                                               \
                WR_CLASS *obj = WR_CAST(bonobo_object_from_servant(s));                           \
                WR_C_CLASS *c = obj->_this;                                                             \
                c->method ( args );                                                                     \
        }                                                                                               \
        rettype WR_C_CLASS::method ( args )

#define WR_METHOD_NOARGS(rettype, method) \
	static rettype static_##method (PortableServer_Servant, CORBA_Environment *); \
        rettype method ( void )

#define WR_METHOD_NOARGS_IMPL(rettype, method) \
