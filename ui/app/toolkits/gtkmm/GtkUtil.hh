...
// Declared the way windows.h does, rather than including it: this header is
// pulled in almost everywhere and windows.h brings macros such as ERROR, IN,
// OUT, min and max with it.
struct HWND__;
using HWND = HWND__ *;
#endif
