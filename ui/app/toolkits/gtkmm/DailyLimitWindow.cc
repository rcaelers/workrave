...
DailyLimitWindow::DailyLimitWindow(std::shared_ptr<IApplication> app, HeadInfo head, BreakFlags break_flags, GUIConfig::BlockMode mode)
  : BreakWindow(app, BREAK_ID_DAILY_LIMIT, head, break_flags, mode)
{
