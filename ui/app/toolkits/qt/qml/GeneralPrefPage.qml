...
Item {
    ...
    Column {
        ...
        PrefGroup {
            width: parent.width
            visible: root.bridge ? (root.bridge.hasLockMethods || root.bridge.hasSleepOperations) : false
            title: qsTr("Lock & power")
            ...
            PrefChoiceRow {
                width: parent.width
                visible: root.bridge ? root.bridge.hasLockMethods : false
            ...
            PrefChoiceRow {
                width: parent.width
                visible: root.bridge ? root.bridge.hasSleepOperations : false
