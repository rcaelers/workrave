...
// StatusWindowPrefPage — content for User interface > Status window preferences.
// Expects context property: statusWindowPrefBridge (StatusWindowPrefBridge)
...
Item {
    ...
    property var bridge: typeof statusWindowPrefBridge !== "undefined" ? statusWindowPrefBridge : null
    ...
    Column {
        ...
        PrefGroup {
            ...
            PrefToggleRow {
                width: parent.width
                label: qsTr("Show status window")
                hint:  qsTr("Turn off to hide the main window — Workrave still runs from the tray.")
    ...
    component PlacementCard: Item {
        ...
        property bool   active:    false
        property string cardTitle: ""
        property var    pattern:   []   // array of arrays, e.g. [["M","R"], ["D"]]
            ...
            Item {
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            id: slotItem
                            required property var modelData    // e.g. ["M","R"]
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    required property string modelData  // "M", "R", or "D"
                                    required property int    index
    ...
    component PerTimerRow: Item {
        ...
        property int    value:      0       // 0=show, 1=first-due, 2=hide
