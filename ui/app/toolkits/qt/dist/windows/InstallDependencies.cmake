...
if (NOT MSVC)
  ...
  foreach(dependency ${resolved_dependencies})
    file(INSTALL ${dependency} DESTINATION "${CMAKE_INSTALL_PREFIX}/${BINDIR}")
    file(APPEND "${RUNTIME_INSTALLERS_LOG}" "${dependency},${BINDIR}\n")
  endforeach()
else()
  file(GLOB_RECURSE PLUGINS "${INSTALL_PATH}/lib/plugins/*.dll")
  ...
  file(INSTALL ${resolved} DESTINATION "${CMAKE_INSTALL_PREFIX}/${BINDIR}")
...
if (EXISTS "${SYS_ROOT}/bin/gdbus.exe")
  file(INSTALL ${SYS_ROOT}/bin/gdbus.exe DESTINATION "${CMAKE_INSTALL_PREFIX}/${BINDIR}")
endif()
