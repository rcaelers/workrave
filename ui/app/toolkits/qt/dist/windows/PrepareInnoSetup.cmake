...
file(GLOB FILES64BIT "${INSTALL_PATH}/${BINDIR}/*.dll")
...
file(GLOB FILES32BIT "${INSTALL_PATH}/${BINDIR32}/*.*")
...
file(APPEND "${LIBS_ISS}" "\n; ARM64\n")
file(GLOB FILESARM64 "${INSTALL_PATH}/binarm/*.*")
foreach(file ${FILESARM64})
  get_filename_component(file ${file} NAME)
  set(flags "ignoreversion restartreplace uninsrestartdelete")
  file(APPEND "${LIBS_ISS}" "Source: \"${INSTALL_WIN_PATH}\\binarm\\${file}\"; DestDir: \"{app}\\binarm\"; Flags: ${flags};\n")
endforeach()
...
if (HAVE_SBOM)
  ...
  file(APPEND "${LIBS_ISS}" "Source: \"${INSTALL_WIN_PATH}\\sbom.spdx.json\"; DestDir: \"{app}\"; Flags: ignoreversion;\n")
endif()
