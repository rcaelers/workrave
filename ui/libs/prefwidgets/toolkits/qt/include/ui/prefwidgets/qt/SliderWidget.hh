...
#ifndef WORKRAVE_UI_PREFWIDGETS_QT_SLIDERWIDGET_HH
#define WORKRAVE_UI_PREFWIDGETS_QT_SLIDERWIDGET_HH
...
namespace ui::prefwidgets::qt
{
  ...
  public:
    SliderWidget(std::shared_ptr<ui::prefwidgets::Value> def,
...
#endif // WORKRAVE_UI_PREFWIDGETS_QT_SLIDERWIDGET_HH
