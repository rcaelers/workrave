...
enum class MenuAction
{
  ...
  NetworkConnect = MENU_COMMAND_NETWORK_CONNECT,
  NetworkDisconnect = MENU_COMMAND_NETWORK_DISCONNECT,
  NetworkLog = MENU_COMMAND_NETWORK_LOG,
  NetworkReconnect = MENU_COMMAND_NETWORK_RECONNECT,
  ...
  NetworkMenu = MENU_COMMAND_NETWORK_SUBMENU,
