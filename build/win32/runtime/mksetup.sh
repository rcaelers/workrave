...
WIN32_MINGW_ENV=${WORKRAVE_GIT_DIR}/build/win32/runtime/mingw
...
cd ${WORKRAVE_GIT_DIR}/libs/hooks/harpoonHelper/src
mkdir Release
cp -a ${TINDERBOX_HOME}/prebuilt/Debug64/harpoonHelper.exe Release
cd ${WORKRAVE_GIT_DIR}/libs/hooks/harpoon/src
mkdir Release
...
cd ${WORKRAVE_GIT_DIR}
. ${WIN32_MINGW_ENV}
${WORKRAVE_GIT_DIR}/build/win32/runtime/autogencross.sh || exit 1
