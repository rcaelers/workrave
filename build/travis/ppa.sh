...
do
    ...
    yes "$GPG_PASSPHRASE" | debuild -p"gpg --batch --pinentry-mode loopback --no-tty --yes --passphrase-fd 0" -d -S -sa -kD5A196C1776BD06C -j8 --lintian-opts --suppress-tags bad-distribution-in-changes-file
