...
CoreModes::Ptr
CoreModes::create(LocalActivityMonitor::Ptr monitor, IConfigurator::Ptr config)
{
  return Ptr(new CoreModes(monitor, config));
}


CoreModes::CoreModes(LocalActivityMonitor::Ptr monitor, IConfigurator::Ptr config) :
